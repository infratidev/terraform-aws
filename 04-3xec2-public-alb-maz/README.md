...
##### Provisionado 3xec2 em subnets públicas utilizando o userdata para instalar um servidor web em 3 AZs com Application Load Balancer 
##### Local state files

##### Estrutura provisionada

![Estrutura](../images/04-3xec2-public-alb-maz.png)
